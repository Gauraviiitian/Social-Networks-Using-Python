...
def get_neigh_for_internal(u, v):
    return [(u+1, v), (u+1, v-1), (u+1, v+1), (u, v-1), (u, v+1), (u-1, v), (u-1, v-1), (u-1, v+1)]
...
def get_neigh_for_boundary(u, v):
    ...
    if u==0 and v==0:
        ...
        return [(u+1, v), (u+1, v-1), (u, v-1), (u, v+1,), (u+1, v+1)]
    elif u==N-1:
...
def make_a_node_satisfied(unsatisfied_nodes_list, empty_cells):
    if len(unsatisfied_nodes_list)!=0:
        ...
        G.node[new_position]['type'] = G.nodes[node_to_shift]['type']
...
display_graph(G)
boundary_nodes_list = list(get_boundary_nodes(G))
